...
;release
rel_ENV:
kmp2_ENV	transeg	1, iRel_ENV, -6, 0.00024787521
...
;Event Clip
kSoftHard_Clip	= kSoftHard < 0.0001 ? 0.0001 : (kSoftHard >= 1 ? 0.9999 : kSoftHard)
...
kFreq_FB table kPitch_FB + 192, 11			;exp table; add 192 for pos. index
kLevel_FB	= 60.0 * (1 - kdly_DT * kFreq_FB)
kLevel_FB	= 0.001 * ampdb(kLevel_FB)

kPitch_FB_Rel	= kPitch_FB + kDamp_FB
kFreq_FB_Rel table kPitch_FB_Rel + 192, 11	;exp table; add 192 for pos. index
...
<EventPanel name="" tempo="60.00000000" loop="8.00000000" x="118" y="351" width="655" height="346" visible="false" loopStart="0" loopEnd="0">i 1 0 0.1 73 </EventPanel>
