/* ------------------------------------------------------------
Code generated with Faust 2.0.a50 (http://faust.grame.fr)
------------------------------------------------------------ */
...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void instanceResetUserInterface() {
		...
		fEntry1 = FAUSTFLOAT(0.10000000000000001);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addNumEntry("attack", &fEntry1, 0.10000000000000001, 0.0, 9999.0, 0.0001);
		ui_interface->declare(&fEntry2, "3", "");
		ui_interface->addNumEntry("decay", &fEntry2, 0.0, 0.0, 9999.0, 0.0001);
		ui_interface->declare(&fEntry3, "4", "");
		ui_interface->addNumEntry("sustain", &fEntry3, 1.0, 0.0, 1.0, 0.0001);
		ui_interface->declare(&fEntry0, "5", "");
		ui_interface->addNumEntry("release", &fEntry0, 0.10000000000000001, 0.0, 9999.0, 0.0001);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		double fSlow4 = (fConst0 * fSlow3);
		int iSlow5 = (1 - iSlow1);
		int iSlow6 = faustpower2_i(iSlow1);
		int iSlow7 = ((fSlow0 == 0.0) > 0);
		double fSlow8 = double(fEntry1);
		double fSlow9 = double(fEntry2);
		double fSlow10 = (fConst0 * (fSlow8 + fSlow9));
		double fSlow11 = (fConst0 * fSlow8);
		double fSlow12 = (0.01 * (double(fEntry3) * fSlow0));
		double fSlow13 = (fConst1 * ((fSlow12 - 1.0) / fSlow9));
		double fSlow14 = (fConst1 / fSlow8);
		double fSlow15 = (fConst1 / fSlow3);
		for (int i = 0; (i < count); i = (i + 1)) {
			fRec0[0] = (iSlow2?0.0:min(fSlow4, (1.0 + fRec0[1])));
			fRec2[0] = (iSlow7?0.0:min(fSlow10, (1.0 + fRec2[1])));
			int iTemp0 = (fRec2[0] < fSlow11);
			fRec1[0] = ((double(iSlow5) * fRec1[1]) + (double(iSlow6) * (iTemp0?((fRec2[0] < 0.0)?0.0:(iTemp0?(fSlow14 * fRec2[0]):1.0)):((fRec2[0] < fSlow10)?(1.0 + (fSlow13 * (fRec2[0] - fSlow11))):fSlow12))));
			output0[i] = FAUSTFLOAT(((fRec0[0] < 0.0)?fRec1[0]:((fRec0[0] < fSlow4)?(fRec1[0] + (fSlow15 * (fRec0[0] * (0.0 - fRec1[0])))):0.0)));
			fRec0[1] = fRec0[0];
			fRec2[1] = fRec2[0];
			fRec1[1] = fRec1[0];
	...
	FAUST_ADDCHECKBOX("trigger", fCheckbox0);
	FAUST_ADDNUMENTRY("attack", fEntry1, 0.10000000000000001, 0.0, 9999.0, 0.0001);
	FAUST_ADDNUMENTRY("decay", fEntry2, 0.0, 0.0, 9999.0, 0.0001);
	FAUST_ADDNUMENTRY("sustain", fEntry3, 1.0, 0.0, 1.0, 0.0001);
	FAUST_ADDNUMENTRY("release", fEntry0, 0.10000000000000001, 0.0, 9999.0, 0.0001);
#endif
